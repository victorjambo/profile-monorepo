/* eslint-disable react/no-unknown-property -- the og way */
import { ImageResponse } from "@vercel/og";
import { ogImageSchema } from "../../../helpers/og";
  ...
  try {
    ...
    return new ImageResponse(
      (
        ...
        >
          <svg fill="none" height="50" viewBox="0 0 212 50" width="212">
            ...
            <defs>
              <clipPath id="a">
                <path d="M0 9.771h150v30.457H0z" fill={paint} />
              </clipPath>
            </defs>
          </svg>
          ...
          <div tw="flex items-center w-full justify-between">
            ...
            >
              ...
              <div tw="flex ml-2">github.com/victorjambo/profile-monorepo</div>
            </div>
          </div>
        </div>
      ),
